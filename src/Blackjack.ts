...
export class Blackjack {
  ...
  resolveRound(player: Player): Outcome {
    ...
    else if (player.hand.isBlackjack && !this.dealer.hand.isBlackjack)
      return Outcome.PlayerBlackjack;
    else if (this.dealer.hand.isBust && !player.hand.isBust)
      return Outcome.PlayerWin;
    else if (player.hand.value > this.dealer.hand.value)
      return Outcome.PlayerWin;
    else if (player.hand.value < this.dealer.hand.value)
